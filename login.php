...
<div class="card" style="width: 18rem;">
  <img src="img/<?= $ptk["gambar"]; ?>" class="card-img-top" alt="...">
  <div class="card-body text-center" style="background-color:darkgrey;">
    <h5 class="card-title"><?= $ptk["judul"];?></h5>
    <br>
    <a href="detail.php?id=<?= $ptk["id"]; ?>" class="badge text-bg-dark text-decoration-none">detail</a>
  </div>
</div>
</div>
<?php endforeach; ?>
